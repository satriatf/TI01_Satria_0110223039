    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="form_kelurahan.php" class="nav-link">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><?=$row["nama"]?></td>
                    <td>
                      <a href="form_kelurahan.php?id_kelurahan=<?php echo $row['id_kelurahan']; ?> "><i class="fas fa-pencil-alt"></i>Update I</a>
                      <a href="proses_kelurahan.php?idx=<?php echo $row['id_kelurahan']; ?>&proses=Hapus"><i class="far fa-trash-alt"></i>Delete</a>
                    </td>
                  </tr>
                  <?php
                  $nomor++;
